...
namespace UHFPS.Runtime
{
    ...
    public class SaveGameManager : Singleton<SaveGameManager>
    {
        ...
        public CustomPassVolume ScreenshotVolume;
        ...
        private void Start()
        {
            ...
            if (loadFlag1 || canLoadWorld)
            {
                ...
                {
                    loadPlayer = true;
                    Log($"Last world state does not exist. Loading is prevented.");
                }
            }
        ...
        {
            if(ScreenshotVolume != null)
            {
                ScreenshotPass screenshotPass = ScreenshotVolume.customPasses[0] as ScreenshotPass;
                StartCoroutine(screenshotPass.CaptureScreenToFile(path));
            }
        }
