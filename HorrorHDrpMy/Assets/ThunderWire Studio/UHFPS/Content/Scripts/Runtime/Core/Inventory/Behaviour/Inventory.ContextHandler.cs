    ...
    public partial class Inventory
    {
        ...
        public void DropItem()
        {
            ...
            if(item.ItemObject != null)
            {
                ...
                foreach (var collider in dropObj.GetComponentsInChildren<Collider>())
                {
                    Physics.IgnoreCollision(collider, playerPresence.PlayerManager.PlayerCollider);
                }
                ...
                // apply interactable item settings
                ...
                // deactivate the player item if it is the current selected item
                if (PlayerItems != null && PlayerItems.CurrentItemIndex == item.UsableSettings.playerItemIndex)
                {
                    // deactivate the player item if it is the current selected item
