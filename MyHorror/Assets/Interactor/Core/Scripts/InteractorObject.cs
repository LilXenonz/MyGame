...
namespace razz
{
    ...
    public static class Tags
    {
        ...
        [TagField(categoryName = "Default")] public const int Once = 10;
        ...
        [TagField(categoryName = "Distance")] public const int Range = 41;
        [TagField(categoryName = "Multiple")] public const int MoveBody = 60;
        [TagField(categoryName = "Self")] public const int PathMover = 70;
    ...
    public enum InteractionTypes
    {
        ...
        DistanceRange = Tags.Range,
        MultipleMoveBody = Tags.MoveBody,
        SelfPathMover = Tags.PathMover,
    ...
    public class InteractorObject : MonoBehaviour
    {
        ...
        [Tooltip("Will resume interaction after the specified number of seconds if the value is greater than 0. This is useful for interactions that start and pause automatically, such as touching a moving object briefly to guide the hand along with it and then leave.")]
        ...
        [HideInInspector] public int animationId;
        #endregion
        ...
        public void GetChildTargets()
        {
            GameObject parent = this.gameObject;
            if (otherTargetsRoot != null) parent = otherTargetsRoot;

            childTargets = parent.GetComponentsInChildren<InteractorTarget>(true);
            ...
            autoMovers = parent.GetComponentsInChildren<AutoMover>(true);
