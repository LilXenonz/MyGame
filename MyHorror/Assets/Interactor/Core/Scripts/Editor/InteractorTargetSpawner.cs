...
namespace razz
{
    public class InteractorTargetSpawner : EditorWindow
    {
        ...
        private ShortcutBinding oldBinding;
#if UNITY_2023_3_OR_NEWER
        private string sceneviewShortcut = "Scene View/Menu";
#else
        private string sceneviewShortcut = "Scene View/Show Scene View Context Menu";
#endif
        ...
        private void ChangeShortcut()
        {
            ...
            {
                ShortcutManager.instance.CreateProfile("NewShortcutProfile");
                ShortcutManager.instance.activeProfileId = "NewShortcutProfile";
            }

            oldBinding = ShortcutManager.instance.GetShortcutBinding(sceneviewShortcut);
            ShortcutManager.instance.RebindShortcut(sceneviewShortcut, ShortcutBinding.empty);
        }

        private void RevertShortcut()
        {
            if (ShortcutManager.instance.IsProfileReadOnly(ShortcutManager.instance.activeProfileId))
            {
                ShortcutManager.instance.CreateProfile("NewShortcutProfile");
            ...
            ShortcutManager.instance.RebindShortcut(sceneviewShortcut, oldBinding);
        }
        ...
        public static void SpawnPrefab(GameObject selectedPrefab, Vector2 mousePos)
        {
            ...
            if (!_interactor) _interactor = Interactor.Instance;
