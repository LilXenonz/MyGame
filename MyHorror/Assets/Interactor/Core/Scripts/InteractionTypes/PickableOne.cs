...
namespace razz
{
    ...
    public class PickableOne : InteractionTypeSettings
    {
        ...
        public bool Pick(Interactor interactor, int effectorType)
        {
            if (oneHandPicked) return false;

            currentIntPoints = interactor.interactorPoints;
            _currentIntIK = interactor.interactorIK;
        ...
        private void CalcThrowPoint()
        {
            ...
            sidedThrowVector = _currentIntIK.GetBone((Interactor.FullBodyBipedEffector)_effectorType).position + sidedThrowVector * 0.5f;
        ...
        private void EnableComponents(Vector3 velocity, Vector3 torque, bool playerVel)
        {
            ...
            if (_intObj.hasRigid)
            {
                ...
                {
                    Vector3 worldTorque = _intObj.currentInteractor.playerTransform.TransformDirection(torque);
                    _intObj.rigid.AddTorque(worldTorque, ForceMode.Impulse);
                }
            }
        ...
        private void SendToInv()
        {
            ...
            if (!onBody)
            {
                ...
                currentIntPoints.inventory.AddItemToInventory(_intObj.itemForInventory);
                TurnOffRenderers();
            ...
            else
            {
                ...
                if (sendToInvToo) currentIntPoints.inventory.AddItemToInventory(_intObj.itemForInventory);
            }
