...
namespace razz
{
    public partial class FullBodyIK
	{
		...
		public struct Matrix3x3
		{
			...
			{
				FBIKMatSetAxisAngle( out this, ref axis, cos );
			}
			...
			{
				float n0 = FBIKSqrt( column0.x * column0.x + column0.y * column0.y + column0.z * column0.z );
				float n1 = FBIKSqrt( column1.x * column1.x + column1.y * column1.y + column1.z * column1.z );
				float n2 = FBIKSqrt( column2.x * column2.x + column2.y * column2.y + column2.z * column2.z );
		...
		public struct Matrix3x4
		{
			...
			public Matrix3x4 inverse
			{
				get
				{
					...
					Vector3 tmp;
					FBIKMatMultVec( out tmp, ref basis_inv, ref origin_minus );
			...
			{
				FBIKMatSetRot( out basis, ref _q );
				origin = _origin;
			}
			...
			{
				Vector3 tmp;
				FBIKMatMultVecAdd( out tmp, ref basis, ref v, ref origin );
				return tmp;
			}
			...
			{
				Vector3 tmp;
				FBIKMatMultVecAdd( out tmp, ref t.basis, ref v, ref t.origin );
				return tmp;
			}
			...
			public Matrix3x4 Multiply( Matrix3x4 t )
			{
				Matrix3x3 tmp_basis;
				Vector3 tmp_origin;
				FBIKMatMult( out tmp_basis, ref basis, ref t.basis );
				FBIKMatMultVecAdd( out tmp_origin, ref basis, ref t.origin, ref origin );
			...
			public static Matrix3x4 operator *( Matrix3x4 t1, Matrix3x4 t2 )
			{
				Matrix3x3 tmp_basis;
				Vector3 tmp_origin;
				FBIKMatMult( out tmp_basis, ref t1.basis, ref t2.basis );
				FBIKMatMultVecAdd( out tmp_origin, ref t1.basis, ref t2.origin, ref t1.origin );
				return new Matrix3x4( ref tmp_basis, ref tmp_origin );
			}
		...
		public static float FBIKSqrt( float a )
		{
			if( a <= FLOAT_EPSILON ) {
				return 0.0f;
			}
		...
		public static float FBIKSqrtClamp01( float a )
		{
			if( a <= FLOAT_EPSILON ) {
				return 0.0f;
		...
		public static float FBIKSin( float a )
		{
			return (float)System.Math.Sin( (double)a );
		}

		public static float FBIKCos( float a )
		{
			return (float)System.Math.Cos( (double)a );
		}

		public static void FBIKCosSin( out float cos, out float sin, float a )
		{
			cos = (float)System.Math.Cos( (double)a );
			sin = (float)System.Math.Sin( (double)a );
		}

		public static float FBIKTan( float a )
		{
			return (float)System.Math.Tan( (double)a );
		}

		public static float FBIKAcos( float cos )
		{
		...
		public static float FBIKAsin( float sin )
		{
		...
		public static void FBIKVecCross( out Vector3 ret, ref Vector3 lhs, ref Vector3 rhs )
		{
			ret = new Vector3(
		...
		public static float FBIKVecLength( ref Vector3 v )
		{
		...
		public static float FBIKVecLengthAndLengthSq( out float lengthSq, ref Vector3 v )
		{
		...
		public static float FBIKVecLength2( ref Vector3 lhs, ref Vector3 rhs )
		{
		...
		public static float FBIKVecLengthSq2( ref Vector3 lhs, ref Vector3 rhs )
		{
			float rx = lhs.x - rhs.x;
			float ry = lhs.y - rhs.y;
			float rz = lhs.z - rhs.z;
		...
		public static float FBIKVecLengthAndLengthSq2( out float lengthSq, ref Vector3 lhs, ref Vector3 rhs )
		{
			float rx = lhs.x - rhs.x;
			float ry = lhs.y - rhs.y;
			float rz = lhs.z - rhs.z;
		...
		public static bool FBIKVecNormalize( ref Vector3 v0 )
		{
		...
		public static bool FBIKVecNormalizeXZ( ref Vector3 v0 )
		{
		...
		public static bool FBIKVecNormalizeYZ( ref Vector3 v0 )
		{
		...
		public static bool FBIKVecNormalize2( ref Vector3 v0, ref Vector3 v1 )
		{
			bool r0 = FBIKVecNormalize( ref v0 );
			bool r1 = FBIKVecNormalize( ref v1 );
			return r0 && r1;
		}

		public static bool FBIKVecNormalize3( ref Vector3 v0, ref Vector3 v1, ref Vector3 v2 )
		{
			bool r0 = FBIKVecNormalize( ref v0 );
			bool r1 = FBIKVecNormalize( ref v1 );
			bool r2 = FBIKVecNormalize( ref v2 );
			return r0 && r1 && r2;
		}

		public static bool FBIKVecNormalize4( ref Vector3 v0, ref Vector3 v1, ref Vector3 v2, ref Vector3 v3 )
		{
			bool r0 = FBIKVecNormalize( ref v0 );
			bool r1 = FBIKVecNormalize( ref v1 );
			bool r2 = FBIKVecNormalize( ref v2 );
			bool r3 = FBIKVecNormalize( ref v3 );
			return r0 && r1 && r2 && r3;
		}

		public static void FBIKMatMult( out Matrix3x3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Matrix3x3(
		...
		public static void FBIKMatMultRet0( ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			lhs = new Matrix3x3(
				lhs.column0.x * rhs.column0.x + lhs.column1.x * rhs.column0.y + lhs.column2.x * rhs.column0.z,
				lhs.column0.x * rhs.column1.x + lhs.column1.x * rhs.column1.y + lhs.column2.x * rhs.column1.z,
		...
		public static void FBIKMatMultCol0( out Vector3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Vector3(
				lhs.column0.x * rhs.column0.x + lhs.column1.x * rhs.column0.y + lhs.column2.x * rhs.column0.z,
				lhs.column0.y * rhs.column0.x + lhs.column1.y * rhs.column0.y + lhs.column2.y * rhs.column0.z,
		...
		public static void FBIKMatMultCol1( out Vector3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Vector3(
				lhs.column0.x * rhs.column1.x + lhs.column1.x * rhs.column1.y + lhs.column2.x * rhs.column1.z,
				lhs.column0.y * rhs.column1.x + lhs.column1.y * rhs.column1.y + lhs.column2.y * rhs.column1.z,
		...
		public static void FBIKMatMultCol2( out Vector3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Vector3(
				lhs.column0.x * rhs.column2.x + lhs.column1.x * rhs.column2.y + lhs.column2.x * rhs.column2.z,
				lhs.column0.y * rhs.column2.x + lhs.column1.y * rhs.column2.y + lhs.column2.y * rhs.column2.z,
		...
		public static void FBIKMatMultVec( out Vector3 ret, ref Matrix3x3 m, ref Vector3 v )
		{
			ret = new Vector3(
		...
		public static void FBIKMatGetRot( out Quaternion q, ref Matrix3x3 m )
		{
			q = new Quaternion();
		...
		public static void FBIKMatSetRot( out Matrix3x3 m, ref Quaternion q )
		{
		...
		public static void FBIKMatSetAxisAngle( out Matrix3x3 m, ref Vector3 axis, float cos )
		{
		...
		public static void FBIKMatFastLerp( out Matrix3x3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs, float rate )
		{
			if( rate <= IKEpsilon ) {
				ret = lhs;
				return;
				...
				if( FBIKVecNormalize3( ref x, ref y, ref z ) ) {
		...
		public static void FBIKMatFastLerpToIdentity( ref Matrix3x3 m, float rate )
		{
			if( rate <= IKEpsilon ) {
			} else if( rate >= 1.0f - IKEpsilon ) {
				m = Matrix3x3.identity;
		...
		public static void FBIKMatMultVecInv( out Vector3 ret, ref Matrix3x3 mat, ref Vector3 vec )
		{
			Matrix3x3 tmpMat = mat.transpose;
			FBIKMatMultVec( out ret, ref tmpMat, ref vec );
		}

		public static void FBIKMatMultVecAdd( out Vector3 ret, ref Matrix3x3 mat, ref Vector3 vec, ref Vector3 addVec )
		{
			FBIKMatMultVec( out ret, ref mat, ref vec );
			ret += addVec;
        }

		public static void FBIKMatMultVecPreSub( out Vector3 ret, ref Matrix3x3 mat, ref Vector3 vec, ref Vector3 subVec )
		{
			Vector3 tmpVec = vec - subVec;
			FBIKMatMultVec( out ret, ref mat, ref tmpVec );
		}

		public static void FBIKMatMultVecPreSubAdd( out Vector3 ret, ref Matrix3x3 mat, ref Vector3 vec, ref Vector3 subVec, ref Vector3 addVec )
		{
			Vector3 tmpVec = vec - subVec;
			FBIKMatMultVec( out ret, ref mat, ref tmpVec );
			ret += addVec;
		...
		public static void FBIKMatMultInv0( out Matrix3x3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Matrix3x3(
		...
		public static void FBIKMatMultInv1( out Matrix3x3 ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			ret = new Matrix3x3(
		...
		public static void FBIKMatMultGetRot( out Quaternion ret, ref Matrix3x3 lhs, ref Matrix3x3 rhs )
		{
			Matrix3x3 tmpMat;
			FBIKMatMult( out tmpMat, ref lhs, ref rhs );
			FBIKMatGetRot( out ret, ref tmpMat );
        }

		public static void FBIKMatSetRotMult( out Matrix3x3 ret, ref Quaternion lhs, ref Quaternion rhs )
		{
			Quaternion q = lhs * rhs;
			FBIKMatSetRot( out ret, ref q );
		}

		public static void FBIKMatSetRotMultInv1( out Matrix3x3 ret, ref Quaternion lhs, ref Quaternion rhs )
		{
			Quaternion q = lhs * Inverse( rhs );
			FBIKMatSetRot( out ret, ref q );
		}

		public static void FBIKQuatMult( out Quaternion ret, ref Quaternion q0, ref Quaternion q1 )
		{
			ret = q0 * q1;
		}

		public static void FBIKQuatMultInv0( out Quaternion ret, ref Quaternion q0, ref Quaternion q1 )
		{
			ret = Inverse( q0 ) * q1;
		}

		public static void FBIKQuatMultNorm( out Quaternion ret, ref Quaternion q0, ref Quaternion q1 )
		{
			ret = Normalize( q0 * q1 );
		}

		public static void FBIKQuatMultNormInv0( out Quaternion ret, ref Quaternion q0, ref Quaternion q1 )
		{
			ret = Normalize( Inverse( q0 ) * q1 );
		}

		public static void FBIKQuatMult3( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = q0 * q1 * q2;
		}

		public static void FBIKQuatMult3Inv0( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = Inverse( q0 ) * q1 * q2;
		}

		public static void FBIKQuatMult3Inv1( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = q0 * Inverse( q1 ) * q2;
		}

		public static void FBIKQuatMultNorm3( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = Normalize( q0 * q1 * q2 );
		}

		public static void FBIKQuatMultNorm3Inv0( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = Normalize( Inverse( q0 ) * q1 * q2 );
		}

		public static void FBIKQuatMultNorm3Inv1( out Quaternion ret, ref Quaternion q0, ref Quaternion q1, ref Quaternion q2 )
		{
			ret = Normalize( q0 * Inverse( q1 ) * q2 );
		}

		public static bool FBIKComputeBasisFromXZLockX( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirZ )
		{
			Vector3 baseY = Vector3.Cross( dirZ, dirX );
			Vector3 baseZ = Vector3.Cross( dirX, baseY );
			if( FBIKVecNormalize2( ref baseY, ref baseZ ) ) {
		...
		public static bool FBIKComputeBasisFromXYLockX( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirY )
		{
		...
		public static bool FBIKComputeBasisFromXYLockY( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirY )
		{
			Vector3 baseZ = Vector3.Cross( dirX, dirY );
			Vector3 baseX = Vector3.Cross( dirY, baseZ );
			if( FBIKVecNormalize2( ref baseX, ref baseZ ) ) {
		...
		public static bool FBIKComputeBasisFromXZLockZ( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirZ )
		{
			Vector3 baseY = Vector3.Cross( dirZ, dirX );
			Vector3 baseX = Vector3.Cross( baseY, dirZ );
			if( FBIKVecNormalize2( ref baseX, ref baseY ) ) {
		...
		public static bool FBIKComputeBasisFromYZLockY( out Matrix3x3 basis, ref Vector3 dirY, ref Vector3 dirZ )
		{
		...
		public static bool FBIKComputeBasisFromYZLockZ( out Matrix3x3 basis, ref Vector3 dirY, ref Vector3 dirZ )
		{
			Vector3 baseX = Vector3.Cross( dirY, dirZ );
		...
		public static bool FBIKComputeBasisLockX( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirY, ref Vector3 dirZ )
		{
			Matrix3x3 basisY;
			Matrix3x3 basisZ;
			bool solveY = FBIKComputeBasisFromXYLockX( out basisY, ref dirX, ref dirY );
			bool solveZ = FBIKComputeBasisFromXZLockX( out basisZ, ref dirX, ref dirZ );
			if( solveY && solveZ ) {
				...
				if( nearZ <= IKEpsilon ) {
					...
					FBIKMatFastLerp( out basis, ref basisY, ref basisZ, nearY / (nearY + nearZ) );
					return true;
				}
			} else if( solveY ) {
				basis = basisY;
		...
		public static bool FBIKComputeBasisLockY( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirY, ref Vector3 dirZ )
		{
			Matrix3x3 basisX;
			Matrix3x3 basisZ;
			bool solveX = FBIKComputeBasisFromXYLockY( out basisX, ref dirX, ref dirY );
			bool solveZ = FBIKComputeBasisFromYZLockY( out basisZ, ref dirY, ref dirZ );
			if( solveX && solveZ ) {
				...
				if( nearZ <= IKEpsilon ) {
					...
					FBIKMatFastLerp( out basis, ref basisX, ref basisZ, nearX / (nearX + nearZ) );
					return true;
				}
			} else if( solveX ) {
				basis = basisX;
		...
		public static bool FBIKComputeBasisLockZ( out Matrix3x3 basis, ref Vector3 dirX, ref Vector3 dirY, ref Vector3 dirZ )
		{
			Matrix3x3 basisX;
			Matrix3x3 basisY;
			bool solveX = FBIKComputeBasisFromXZLockZ( out basisX, ref dirX, ref dirZ );
			bool solveY = FBIKComputeBasisFromYZLockZ( out basisY, ref dirY, ref dirZ );
			if( solveX && solveY ) {
				...
				if( nearY <= IKEpsilon ) {
					...
					FBIKMatFastLerp( out basis, ref basisX, ref basisY, nearX / (nearX + nearY) );
					return true;
				}
			} else if( solveX ) {
				basis = basisX;
		...
		public struct FastLength
		{
			...
			{
				return new FastLength( FBIKSqrt( lengthSq ), lengthSq );
			}

			public static FastLength FromVector3( Vector3 v )
			{
				float lengthSq;
				float length = FBIKVecLengthAndLengthSq( out lengthSq, ref v );
			...
			{
				float lengthSq;
				float length = FBIKVecLengthAndLengthSq2( out lengthSq, ref v0, ref v1 );
				return new FastLength( length, lengthSq );
			}
		...
		public static bool FBIKComputeBasisFromXZLockX( out Matrix3x3 basis, Vector3 dirX, Vector3 dirZ )
		{
			return FBIKComputeBasisFromXZLockX( out basis, ref dirX, ref dirZ );
		}

		public static bool FBIKComputeBasisFromXYLockX( out Matrix3x3 basis, Vector3 dirX, Vector3 dirY )
		{
			return FBIKComputeBasisFromXYLockX( out basis, ref dirX, ref dirY );
		}

		public static bool FBIKComputeBasisFromXYLockY( out Matrix3x3 basis, Vector3 dirX, Vector3 dirY )
		{
			return FBIKComputeBasisFromXYLockY( out basis, ref dirX, ref dirY );
		}

		public static bool FBIKComputeBasisFromXZLockZ( out Matrix3x3 basis, Vector3 dirX, Vector3 dirZ )
		{
			return FBIKComputeBasisFromXZLockZ( out basis, ref dirX, ref dirZ );
		}

		public static bool FBIKComputeBasisFromYZLockY( out Matrix3x3 basis, Vector3 dirY, Vector3 dirZ )
		{
			return FBIKComputeBasisFromYZLockY( out basis, ref dirY, ref dirZ );
		}

		public static bool FBIKComputeBasisFromYZLockZ( out Matrix3x3 basis, Vector3 dirY, Vector3 dirZ )
		{
			return FBIKComputeBasisFromYZLockZ( out basis, ref dirY, ref dirZ );
		}

		public static bool FBIKComputeBasisFrom( out Matrix3x3 basis, ref Matrix3x3 rootBasis, ref Vector3 dir, _DirectionAs directionAs )
		{
			switch( directionAs ) {
			case _DirectionAs.XPlus:
				return FBIKComputeBasisFromXYLockX( out basis, dir, rootBasis.column1 );
			case _DirectionAs.XMinus:
				return FBIKComputeBasisFromXYLockX( out basis, -dir, rootBasis.column1 );
			case _DirectionAs.YPlus:
				return FBIKComputeBasisFromXYLockY( out basis, rootBasis.column0, dir );
			...
			float lenC )
		{
			...
			if( bc2 > IKEpsilon ) {
				...
				return FBIKSqrtClamp01( 1.0f - cs * cs );
			}
			...
			out Vector3 axis )
		{
			...
			if( !FBIKVecNormalize2( ref dirFrom, ref dirTo ) ) {
				theta = 0.0f;
			...
			float limitYPlus )
		{
			...
			if( isXLimited || isYLimited ) {
				dir.z = FBIKSqrt( 1.0f - (dir.x * dir.x + dir.y * dir.y) );
				return true;
			} else {
				if( dir.z < 0.0f ) {
					dir.z = -dir.z;
			...
			float limitZPlus )
		{
			...
			if( isYLimited || isZLimited ) {
				dir.x = FBIKSqrt( 1.0f - (dir.y * dir.y + dir.z * dir.z) );
				if( !isRight ) {
					dir.x = -dir.x;
				}
				return true;
			...
			float limitZPlus )
		{
			...
			if( isXLimited || isZLimited ) {
				dir.y = FBIKSqrt( 1.0f - (dir.x * dir.x + dir.z * dir.z) );
				return true;
			} else {
				if( dir.y < 0.0f ) {
					dir.y = -dir.y;
			...
			float limitYPlus )
		{
			...
			if( xLimit <= IKEpsilon && yLimit <= IKEpsilon ) {
				...
				float localLen = FBIKSqrt( localX * localX + localY * localY + dir.z * dir.z );

				float inv_localLen = (localLen > IKEpsilon) ? (1.0f / localLen) : 0.0f;
				float nrm_localX = localX * inv_localLen;
				float nrm_localY = localY * inv_localLen;
				...
				if( isLimited ) {
					...
					float limitSin = FBIKSqrt( limitSinSq );
					float limitCos = FBIKSqrt( 1.0f - limitSin * limitSin );
					dir.x = worldX;
					dir.y = worldY;
					dir.z = limitCos;
				} else if( isInverse ) {
			...
			float limiZPlus )
		{
			...
			if( xLimit <= IKEpsilon && zLimit <= IKEpsilon ) {
				...
				float localLen = FBIKSqrt( localX * localX + localZ * localZ + dir.y * dir.y );

				float inv_localLen = (localLen > IKEpsilon) ? (1.0f / localLen) : 0.0f;
				float nrm_localX = localX * inv_localLen;
				float nrm_localZ = localZ * inv_localLen;
			...
			float limitZPlus )
		{
			...
			if( yLimit <= IKEpsilon && zLimit <= IKEpsilon ) {
				...
				float localY = dir.y * inv_yLimit;
				float localZ = dir.z * inv_zLimit;
				float localLen = FBIKSqrt( dir.x * dir.x + localY * localY + localZ * localZ );
		...
		public static bool _LimitToPlaneDirY( ref Vector3 dir, Vector3 planeDir, float thetaY )
		{
			...
			Vector3 tmp = dir - planeDir * d;
			float tmpLen = FBIKVecLength( ref tmp );
			if( tmpLen <= FLOAT_EPSILON ) {
				return false;
			}

			float targetLen = FBIKSqrt( 1.0f - thetaY * thetaY );
		...
		static void _LerpRotateBasis( out Matrix3x3 basis, ref Vector3 axis, float cos, float rate )
		{
			...
			FBIKMatSetAxisAngle( out basis, ref axis, cos );
		}
		...
		public static Vector3 _LerpDir( ref Vector3 src, ref Vector3 dst, float r )
		{
			...
			if( _ComputeThetaAxis( ref src, ref dst, out theta, out axis ) ) {
				...
				Vector3 tmp;
				FBIKMatMultVec( out tmp, ref basis, ref src );
				return tmp;
			}
