...
namespace razz
{
    ...
    public class FreeLookCam : MonoBehaviour
    {
        ...
        void Update()
        {
            if (InteractorInput.GetKeyDown(KeyCode.Escape))
            {
            ...
            if (InteractorInput.GetRightClickRelease())
            {
                if (_screenLock)
                {
                    Cursor.lockState = CursorLockMode.None;
        ...
        private void HandleRotationMovement()
        {
            ...
            float x = _screenLock ? InteractorInput.GetMouseX() : 0;
            float y = 0;
            ...
            if (lockers.Count == 0)
            {
                y = _screenLock ? InteractorInput.GetMouseY() : 0;
        ...
        public void LockCamY(GameObject lockerObject)
        {
            if (lockers.Count == 0)
            {
