...
namespace razz
{
    public class PickupTestInputs : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                if (InteractorInput.GetKeyDown(holdInteractions[i].key))
                {
            ...
            {
                if (InteractorInput.GetKeyDown(dropInteractions[i].key))
                {
            ...
            {
                if (InteractorInput.GetKeyDown(holdDropInteractions[i].key))
                {
            ...
            if (InteractorInput.GetKeyDown(throwAll))
            {
            ...
            if (InteractorInput.GetKeyDown(reloadKey))
            {
            ...
            if (InteractorInput.GetKeyDown(weaponInvKey))
            {
