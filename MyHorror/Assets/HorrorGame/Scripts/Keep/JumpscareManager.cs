...
public class JumpscareManager : Singleton<JumpscareManager>
{
    ...
    public JumpscareDirect jumpscareDirect;

    //private WobbleMotion wobbleMotion;
    
    public WobbleApplier wobbleApplier;
    ...
    private void Awake()
    {
        ...
        //lookController = GetComponent<FirstPersonController>();
    ...
    public void StartJumpscareEffect(JumpscareTrigger jumpscare)
    {
        if (jumpscare.InfluenceWobble)
        {
            ...
            wobbleApplier.ApplyWobble(amplitude, frequency, duration);
        }
